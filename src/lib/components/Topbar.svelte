...
<header class="bg-slate-200 h-22 items-center relative shadow-2xl w-full z-99">
	<div class="flex flex-center flex-col h-full justify-center mx-auto px-3 relative shadow-xl">
